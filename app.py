...
def classify_batch():
    try:
        ...
        prompt_tmpl = PromptTemplate(
            "Imagine you're an expert at analyzing human behavior. Based on web site traffic data, rate the degree of distraction from work from 0 to 10. Data from recent visits: {content}."
        )
        print(prompt_tmpl)
